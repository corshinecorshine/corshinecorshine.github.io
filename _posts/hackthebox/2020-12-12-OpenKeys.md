...
There are 3 `CVEs` to get root, I used `CVE-2019-19520` & `CVE-2019-19522` which both of them are related to each other, in order to get root, I had to executed `CVE-2019-19520` before `CVE-2019-19522`.
